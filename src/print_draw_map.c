...
/*   Updated: 2025/02/28 17:53:38 by student          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_level_done(t_mlx *mlx)
{
	...
	mlx_string_put(mlx->mlx_ptr, mlx->win_ptr, mlx->width_win / 2 - 100,
		mlx->height_win / 2 + 50, 0x000000, "PRESS ESC TO QUIT PROGRAM");
	free(message);
}
